    ...
    try {
        ...
        <html>
            ...
            <div class=" flex flex-col  w-screen">
             ...
             <!-- Header Section -->
                <div class="bg-stone-800 text-white min-h-36 flex items-center justify-between flex-row pl-24 pr-36" >
                  
                        <div class="w-28 h-28 rounded-full overflow-hidden border-4 border-white">
                                <img class="object-cover w-full h-full" src="https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg">
                        
                  
                   
                        </div>
                    <div class=" flex flex-col justify-center items-center ml-5 gap-3">
                        <h1 class="text-4xl font-semibold mb-1">AKASH G</h1>
